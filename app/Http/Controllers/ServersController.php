...
class ServersController extends Controller
{
    ...
    {
        return view("servers.create", ['name' => rand_server_name()]);
    }
    ...
    public function store()
    {
        ...
        return redirect()->route('servers.sites', ['server' => $server->id, 'showModal' => 1]);
    }
    ...
    {
        return view("servers.sites", compact('server'));
    }
